...
const (
	...
	textCompareResultPrompt     = "compare.result"
	textCompareCloseAction      = "compare.close"
...
var zhText = map[string]string{
	...
	textCompareResultPrompt:     "文件对比结果",
	textCompareCloseAction:      "[Enter]/[q] 关闭",
...
func enText(key string) string {
	...
	case textUpdateProgressPreparing:
		return "Preparing"
	case textCompareResultPrompt:
		return "File compare result"
	case textCompareCloseAction:
